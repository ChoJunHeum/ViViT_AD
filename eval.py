...
def main(cfg):
    ...
    test_dirs = glob.glob(f'{cfg.te_path}/testing/*')
    test_dirs.sort()
    ...
    print(f'auc: {res["auc"]:.4f}, elapsed: {res["elapsed"]/60:.2f} mins')
    return None
...
if __name__ == "__main__":
    ...
    # epoch = 10
    # checkpoint = f'20220802-01/total_model_e{epoch}.pt'
    # args = parser.parse_args(['-ck', checkpoint])
